...
class Intro1(OPU_Slide):
    def construct(self):
        ...
        version = Text("Version 02").scale(0.25).next_to(title,RIGHT).align_to(title, DOWN)
...
class Admin(OPU_Slide):
    def construct(self):
        ...
        bul1 = "Guy Tordjman - Course Lecturer.     email : turgibot@gmail.com."
...
class HowTo(OPU_Slide):
    def construct(self):
        ...
        bul1 = "Watch Dr. Elishai's videos."
        bul2 = "Recommended to solve a few questions from the book before class."
        bul3 = "Zoom and participate in lessons.(sessions are recorded and uploaded)"
        bul4 = "Complete all the assignments"
        bul5 = "Ask anything during lecture. email anytime or call/whatsapp me on Tuesday 13:00-15:00 at 053-7203788"
...
class Overview(OPU_Slide):
    def construct(self):
        ...
        secondary_title = Text("The course subjects 5 chapters from the book:", color=BLUE).next_to(title, DOWN).scale(0.4)
